...
function scaleBurikoTrueColorBitmapNearestPixels(
...
export const scaleBurikoTrueColorBitmapNearest = withBurikoBitmapText(
  scaleBurikoTrueColorBitmapNearestPixels,
  {
    replace: true,
    region: (args) => {
