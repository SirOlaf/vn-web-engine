...
export function createGroup80Procedures(
  procedures: BurikoIndependentProcedures,
    ...
    },
    {
      ...
      execute: (h) => {
        ...
        if (procedure !== null) {
          ...
          if (output === null) throw new Error('Buriko independent procedure null result pointer');
    ...
    },
    {
      ...
      execute: (h) => {
        ...
        if (procedure !== null && (count - 1) >>> 0 < 256) {
          if (input === null) throw new Error('Buriko independent procedure null message pointer');
