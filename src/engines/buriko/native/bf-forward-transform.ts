import {burikoMovieAanScale} from '../../../formats/buriko/movie-idct.js';
...
export function burikoBfEncoderQuantization(quality: number): {
  bytes: Uint8Array;
  ...
  for (let component = 0; component < 2; component++)
    for (let index = 0; index < 64; index++) {
      ...
      multipliers[component * 64 + index] = f(1 / (f(q * burikoMovieAanScale[index]!) * 8));
    }
...
export function burikoBfEncoderComponents(
  b: number,
  g: number,
  r: number,
...
export function burikoBfForwardBlock(
