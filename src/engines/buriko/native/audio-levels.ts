...
export class BurikoAudioLevels {
  master = 0;
  additional = 0;
  readonly volume = new BurikoAudioFade();
  readonly envelope = new BurikoAudioFade();
...
export function burikoAudioVolumeDecibels(attenuation: number): number {
