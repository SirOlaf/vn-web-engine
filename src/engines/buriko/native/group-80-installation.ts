...
import type {BurikoInstallationCall} from './installation.js';
import type {BurikoInstallerModal} from './installer-modal.js';
...
export function createGroup80Installation(
  modal: BurikoInstallerModal,
      ...
      execute: async (context): Promise<0> => {
        const cancellable = pop32(context.thread),
          ...
          call: BurikoInstallationCall = {
            ...
            uninstallerRetryMessage: optionalString(
              context,
              retryAddress,
