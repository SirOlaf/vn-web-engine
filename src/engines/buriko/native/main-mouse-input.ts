...
export interface BurikoMainWheelTranslator {
...
export class BurikoMainMouseInput {
  ...
  constructor(
    ...
    readonly wheel: BurikoMainWheelTranslator | null = null,
    ...
    if (
      ...
      throw new Error('Buriko main mouse requires the shared live main-window owners');
  ...
  private readonly onWheel = (event: WheelEvent): void => {
    ...
    for (const transition of transitions) {
      if (
        ...
        throw new RangeError('Buriko wheel translator requires signed native wheel deltas');
    }
