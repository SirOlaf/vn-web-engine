  ...
  return [
    {
      ...
      execute: async (h): Promise<0> => {
        ...
        if (result.metric === undefined)
          throw new Error('Buriko mono wrapper consumes an unwritten extent');
