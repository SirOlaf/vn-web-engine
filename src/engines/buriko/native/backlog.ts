...
function required(pointer: BurikoBpPointer | null): BurikoBpPointer {
  if (pointer === null) throw new RangeError('Buriko backlog consumed a null native pointer');
  return pointer;
}
/** C2960/C2700/C24F0: distinct backlog sentinel1E90B0 and count1E90A8. */
export class BurikoBacklog {
  ...
  append(values: readonly number[], pointers: readonly (BurikoBpPointer | null)[]): number {
