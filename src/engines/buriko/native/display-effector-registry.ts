...
export type BurikoDisplayEffector = BurikoDisplayObject & {effectorMode: number};
interface EffectorLink {
  object: BurikoDisplayEffector;
  next: EffectorLink | null;
}

/** The independent linked roots at 1d1d38; the actual manager still owns the pool slots. */
export class BurikoDisplayEffectorRegistry {
