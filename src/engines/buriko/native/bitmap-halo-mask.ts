...
import {bitmapStorage, cropBurikoBitmap, type BurikoBitmap} from './bitmap.js';
...
function createBurikoHaloMaskPixels(
...
export const createBurikoHaloMask = withBurikoBitmapText(createBurikoHaloMaskPixels, {
  alternateArgs: (args) =>
    [args[0], args[1], args[2], burikoBitmapTextCompositor(args[3])] as Parameters<
      typeof createBurikoHaloMaskPixels
    >,
  replace: true,
