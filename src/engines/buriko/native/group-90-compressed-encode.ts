...
import type {BurikoCompressedSurfaceEncoder} from './surface-compressed-encode.js';
import type {BurikoNativeSlotDefinition} from './types.js';

export function createGroup90CompressedEncode(
  encoder: BurikoCompressedSurfaceEncoder,
  ...
  return [
    {
      ...
      execute: (h) => {
        ...
        if (encoded.length > 256)
          throw new RangeError('Buriko encoder diagnostic exceeds native scratch');
