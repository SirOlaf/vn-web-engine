...
export function formatBurikoObjectList(objects: readonly BurikoDisplayObject[]): Uint8Array {
  ...
  for (const object of objects) {
    ...
    if (label === undefined)
      throw new Error('Buriko object diagnostic indexes outside its native category table');
