...
import type {BurikoInternetReadOperation, BurikoInternetReads} from './internet-reads.js';
...
export class BurikoInternetReadProcess extends BurikoProcedure {
  private readonly url: Uint8Array;
  private operation: BurikoInternetReadOperation | null = null;
  ...
  constructor(
    ...
    private readonly reads: BurikoInternetReads,
