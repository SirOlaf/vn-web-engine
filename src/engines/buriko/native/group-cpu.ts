...
export function createGroupCpu(cpu: BurikoCpuProfile): BurikoNativeSlotDefinition[] {
  return [
    {
      primary: 0x80,
      secondary: 0x0a,
      ...
      execute: (h) => {
        ...
        if (destination === null) throw new Error('Buriko CPU record null destination');
    ...
    },
    {
      ...
      execute: (h) => {
        ...
        if (brand !== null) {
          if (destination === null) throw new Error('Buriko CPU brand null destination');
