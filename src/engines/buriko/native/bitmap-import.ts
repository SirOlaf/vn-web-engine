...
function makeBurikoBitmapOpaquePixels(bitmap: BurikoBitmap): void {
...
function removeBurikoBitmapMattePixels(bitmap: BurikoBitmap, color: number): 0 | 1 {
  color >>>= 0;
...
export const makeBurikoBitmapOpaque = withBurikoBitmapText(makeBurikoBitmapOpaquePixels, {
  source: 0,
  replace: true,
});

export const removeBurikoBitmapMatte = withBurikoBitmapText(removeBurikoBitmapMattePixels, {
  source: 0,
  replace: true,
