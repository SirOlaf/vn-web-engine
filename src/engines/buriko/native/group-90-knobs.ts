...
export function createGroup90Knobs(
  ...
  const fatal = (context: BurikoBpOpcodeContext, message: string): Promise<never> =>
    ...
    invalidKnob = (context: BurikoBpOpcodeContext): Promise<never> =>
...
export function createGroup91KnobPointer(knobs: BurikoKnobDisplays): BurikoNativeSlotDefinition[] {
  return [
    {
      primary: 0x91,
      secondary: 0xdb,
