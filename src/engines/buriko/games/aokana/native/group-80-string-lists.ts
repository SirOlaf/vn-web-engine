...
export function createGroup80StringLists(lists: AokanaStringLists): AokanaNativeSlotDefinition[] {
  return [
    {
      primary: 0x80,
      secondary: 0xd8,
    ...
    ).map(([secondary, nativeAddress, name]): AokanaNativeSlotDefinition => ({
      primary: 0x80,
      secondary,
      nativeAddress,
      name,
