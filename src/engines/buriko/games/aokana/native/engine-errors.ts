...
import {AokanaSaveRoot} from './save-root.js';
...
export class AokanaEngineErrors {
  ...
  readonly saveRoot: AokanaSaveRoot;
  constructor(
    readonly files: AokanaProgramFiles,
    readonly dialogs: AokanaEngineDialogs,
    errorDirectory: Uint8Array | AokanaSaveRoot,
    public workingDirectory: Uint8Array,
  ) {
    this.saveRoot =
      errorDirectory instanceof AokanaSaveRoot
        ? errorDirectory
        : new AokanaSaveRoot(files, errorDirectory);
  }
