...
function reduceAokanaBitmapHalfPixels(destination: AokanaBitmap, source: AokanaBitmap): void {
...
export const reduceAokanaBitmapHalf = withAokanaBitmapText(reduceAokanaBitmapHalfPixels, {
  replace: true,
  region: (args) => ({
    x: 0,
    y: 0,
