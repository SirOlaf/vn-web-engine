...
import type {AokanaExternalLibraries} from './external-libraries.js';
...
export function createGroup80ExternalLibraries(
  libraries: AokanaExternalLibraries,
  ...
  return [
    {
      ...
      execute: (h) => {
        ...
        if (name === null) throw new Error('Aokana DLL load dereferences a null name');
