...
export function createGroupC0Bwef(resources: AokanaProgramResources): AokanaNativeSlotDefinition[] {
  return [
    {
      primary: 0xc0,
      secondary: 0xf0,
      ...
      execute: async (h): Promise<0> => {
        ...
        if (name === null) throw new Error('Aokana BWEF loader dereferences a null resource name');
        push32(
          h.thread,
          await loadBwefPairs(
            resources,
