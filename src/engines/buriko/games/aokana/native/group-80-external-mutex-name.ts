...
import type {AokanaExternalMutexName} from './external-mutex-name.js';
  ...
  return [
    {
      ...
      execute: ({thread, memory}) => {
        ...
        if (pointer === null) throw new Error('Aokana uninstaller mutex name pointer is null');
