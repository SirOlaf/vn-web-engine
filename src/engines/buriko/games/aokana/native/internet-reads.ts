...
export class AokanaInternetReads {
  ...
  constructor(
    readonly files: Pick<AokanaProgramFiles, 'text'>,
    readonly host: AokanaInternetReadHost,
  ) {}
  ...
  async read(
    ...
    if (this.closed) throw new Error('Aokana internet-read admission is closed');
