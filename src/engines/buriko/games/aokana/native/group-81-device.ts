...
import {readAokanaDisplayAdapter, setAokanaRequestedClientSize} from './display-services.js';
  ...
  return [
    {
      ...
      execute: (h) => {
        ...
        readAokanaDisplayAdapter(controller.display, description!, version!);
        return 0;
      },
    },
    {
    ...
    },
    {
      ...
      execute: async (h): Promise<0> => {
        ...
        await setAokanaRequestedClientSize(controller, width, height, null);
        return 0;
      },
    },
    {
