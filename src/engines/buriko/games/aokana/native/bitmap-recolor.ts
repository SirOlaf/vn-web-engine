...
function recolorAokanaBitmapAlphaPixels(
...
export const recolorAokanaBitmapAlpha = withAokanaBitmapText(recolorAokanaBitmapAlphaPixels, {
...
function replaceAokanaBitmapColorPixels(
  bitmap: AokanaBitmap,
  search: number,
  replacement: number,
): void {
...
export const replaceAokanaBitmapColor = withAokanaBitmapText(replaceAokanaBitmapColorPixels, {
  source: 0,
  replace: true,
  color: (color, args) =>
