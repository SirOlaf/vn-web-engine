...
export class AokanaDisplayTexture {
  ...
  private presentationView: AokanaDisplayTexture | null = null;
  ...
  forPresentation(): AokanaDisplayTexture {
    this.check();
    return (this.presentationView ??= Object.create(this) as AokanaDisplayTexture);
  }
