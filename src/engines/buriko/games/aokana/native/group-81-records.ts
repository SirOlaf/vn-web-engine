...
import type {AokanaNativeRecordBuffers} from './record-buffers.js';
import type {AokanaNativeSlotDefinition} from './types.js';

export function createGroup81Records(
  records: AokanaNativeRecordBuffers,
...
export const group81Disabled: AokanaNativeSlotDefinition[] = [
  ...[
    [0x8c, 0x1400eb080],
    [0x8e, 0x1400eaf80],
    ...
    execute: (h: Parameters<AokanaNativeSlotDefinition['execute']>[0]) => {
      pop32(h.thread);
