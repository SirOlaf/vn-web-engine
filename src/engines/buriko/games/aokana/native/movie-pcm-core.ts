...
export class AokanaMoviePcmCore {
  ...
  private gain = 1;
  readonly format: AokanaMoviePcmFormat;
  constructor(
  ...
  status(result: AokanaMoviePcmStatus['result'] = 'ok'): AokanaMoviePcmStatus {
    return {
      result,
  ...
  render(output: readonly Float32Array[]): AokanaMoviePcmStatus {
