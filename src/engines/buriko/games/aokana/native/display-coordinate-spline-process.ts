...
export class AokanaCoordinateSplineControlProcess extends AokanaDisplayControlProcess {
  private readonly spline = new AokanaNativeSpline();
  ...
  initializeCoordinates(
    ...
    if (points === null) throw new Error('Aokana coordinate control dereferences null points');
