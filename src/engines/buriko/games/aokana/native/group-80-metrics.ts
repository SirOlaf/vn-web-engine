...
import type {AokanaFrameMetrics} from './frame-metrics.js';
import type {AokanaNativeSlotDefinition} from './types.js';

/** 80 06/07 share the actual simulation/draw measurement owner at 1d0390. */
export function createGroup80Metrics(metrics: AokanaFrameMetrics): AokanaNativeSlotDefinition[] {
  return [
    {
      primary: 0x80,
      secondary: 0x06,
    ...
    },
    {
      ...
      execute: (h) => {
        ...
        if (destination === null) throw new Error('Aokana frame metric null destination');
