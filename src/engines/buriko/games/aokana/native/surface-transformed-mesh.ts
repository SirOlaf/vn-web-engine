import {drawAokanaTransformedMesh} from './bitmap-transformed-mesh.js';
import type {AokanaMeshGeometry} from './bitmap-mesh.js';
import type {AokanaSurfaces} from './surfaces.js';

export interface AokanaSurfaceMeshParameters extends Omit<AokanaMeshGeometry, 'source'> {
...
export function drawAokanaSurfaceTransformedMesh(
  surfaces: AokanaSurfaces,
  parameters: AokanaSurfaceMeshParameters,
