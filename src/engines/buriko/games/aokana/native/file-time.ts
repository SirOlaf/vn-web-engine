...
export function aokanaSystemTimeToFileTime(input: AokanaBpPointer): bigint | null {
...
export function aokanaFileTimeToSystemTime(time: bigint): Uint16Array | null {
...
export function writeAokanaSystemTime(output: AokanaBpPointer, time: bigint): boolean {
  const fields = aokanaFileTimeToSystemTime(time);
