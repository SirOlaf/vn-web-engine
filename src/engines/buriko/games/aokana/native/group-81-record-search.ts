...
import {findAokanaMatchingRecord, writeAokanaMatchingRecordIndices} from './record-search.js';
...
export function createGroup81RecordSearch(): AokanaNativeSlotDefinition[] {
  return [
    {
      primary: 0x81,
      secondary: 0xb8,
      ...
      execute: (h) => {
        ...
        push32(
          h.thread,
          findAokanaMatchingRecord(source, count, stride, comparison, format, options),
        );
        return 0;
      },
    },
