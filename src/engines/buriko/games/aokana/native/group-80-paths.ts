...
import type {AokanaPathFileDirectory} from './path-file-directory.js';
import type {AokanaNativeSlotDefinition} from './types.js';

export function createGroup80Paths(paths: AokanaPathFileDirectory): AokanaNativeSlotDefinition[] {
  return [
    {
      primary: 0x80,
      secondary: 0x28,
