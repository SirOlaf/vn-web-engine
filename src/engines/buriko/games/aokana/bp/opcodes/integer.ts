...
function binary(fn: (a: number, b: number) => number): AokanaBpOpcodeHandler {
  return (h) => {
...
function immediate(h: AokanaBpOpcodeContext, operation: number): 0 {
...
export const integerOpcodes: Readonly<Record<number, AokanaBpOpcodeHandler>> = {
