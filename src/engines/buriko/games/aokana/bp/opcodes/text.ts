...
function nonnull(pointer: AokanaBpPointer | null): AokanaBpPointer {
  if (pointer === null) throw new Error('Aokana native text dereferences a null pointer');
  return pointer;
}

function displaced(pointer: AokanaBpPointer, offset: number): AokanaBpPointer {
...
function replaceText(
  ...
  needle: AokanaBpPointer,
  replacement: AokanaBpPointer,
): number {
