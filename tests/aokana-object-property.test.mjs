...
import {createGroup91ObjectProperty} from '../dist/engines/buriko/native/group-91-object-property.js';
...
test('property query writes a packed caller record consumed by real Sprite rendering', () => {
  ...
  assert.equal(slot.nativeAddress, BURIKO_NATIVE_SLOT_ADDRESSES[0x91][0x38]);
