...
import {createGroup90BackdropBlur} from '../dist/engines/buriko/native/group-90-backdrop-blur.js';
...
test('blur backdrop selects real horizontal zero and clamped edge kernels', () => {
  ...
  assert.equal(slot.nativeAddress, BURIKO_NATIVE_SLOT_ADDRESSES[0x90][0x46]);
