...
import {createGroupE0InputCaptures} from '../dist/engines/buriko/games/aokana/native/group-e0-input-captures.js';
...
test('input capture list merges actual capture owners through the native selection dialog', async () => {
  ...
  assert.deepEqual(
    ...
    [0xe0, 0x40, AOKANA_NATIVE_SLOT_ADDRESSES[0xe0][0x40]],
  );
