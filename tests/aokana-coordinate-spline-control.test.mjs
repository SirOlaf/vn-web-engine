...
import {createGroup90CoordinateSplineControl} from '../dist/engines/buriko/games/aokana/native/group-90-coordinate-spline-control.js';
...
test('coordinate spline controls share scheduled waits, spline sampling, sort lists and capture completion', async () => {
  ...
  const clock = new AokanaNativeClock(() => tick),
    ...
    context = {thread, memory: new AokanaBpMemory(bytes), diagnostics: {}},
